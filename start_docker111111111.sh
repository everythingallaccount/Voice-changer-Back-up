...
docker run -it --rm --gpus all --shm-size=1024M    -e EX_IP=192.168.191.96      -e EX_PORT=18888     -e LOCAL_UID=1000     -e LOCAL_GID=1000     -p 18888:18888     vcclient -p 18888 --https true         --content_vec_500 pretrain/checkpoint_best_legacy_500.pt          --hubert_base pretrain/hubert_base.pt         --hubert_soft pretrain/hubert/hubert-soft-0d54a1f4.pt         --nsf_hifigan pretrain/nsf_hifigan/model         --hubert_base_jp pretrain/rinna_hubert_base_jp.pt         --model_dir model_dir
